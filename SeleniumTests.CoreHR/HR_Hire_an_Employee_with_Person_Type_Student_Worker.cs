...
namespace SeleniumTests.CoreHR
{
    ...
    public class HR_Hire_an_Employee_with_Person_Type_Student_Worker : BaseTest
    {
        static string testName = "HireAnEmployee_Test1";
        [Test, TestCaseSource("getData")]
        public void HR_Hire_an_Employee_with_Person_Type_Student_Worker_Test(Dictionary<string, string> data)
        {
