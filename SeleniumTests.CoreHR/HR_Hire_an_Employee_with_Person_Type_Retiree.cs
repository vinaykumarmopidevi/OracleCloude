...
namespace SeleniumTests.CoreHR
{
   ...
   // [Parallelizable(ParallelScope.Self)]
    public class HR_Hire_an_Employee_with_Person_Type_Retiree : BaseTest
    {
        static string testName = "HireAnEmployee_Test1";
        [Test, TestCaseSource("getData")]
        public void HR_Hire_an_Employee_with_Person_Type_Retiree_Test(Dictionary<string, string> data)
        {   
