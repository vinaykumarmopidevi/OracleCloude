...
using TestFrameworkTutorial.TestBaseUtility;
using Tests.PageObjects.CompensationManagement;

namespace Tests.Scenarios.CompensationManagement
{
    [TestFixture]
   // [Parallelizable(ParallelScope.Self)]
    public class CM_Defining_Derived_Eligibility_Factor_for_Length_of_Service : BaseTest
    {
        static string testName = "HireAnEmployee";
        [Test, TestCaseSource("getData")]
        public void CM_Defining_Derived_Eligibility_Factor_for_Length_of_Service_Test(Dictionary<string, string> data)
        {   
