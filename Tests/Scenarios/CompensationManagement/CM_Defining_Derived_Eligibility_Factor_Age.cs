...
namespace Tests.Scenarios.CompensationManagement
{
   ...
   // [Parallelizable(ParallelScope.Self)]
    public class CM_Defining_Derived_Eligibility_Factor_Age : BaseTest
    {
        static string testName = "HireAnEmployee";
        [Test, TestCaseSource("getData")]
        public void CM_Defining_Derived_Eligibility_Factor_Age_Test(Dictionary<string, string> data)
        {   
