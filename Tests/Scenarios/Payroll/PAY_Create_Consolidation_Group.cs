...
using TestFrameworkTutorial.TestBaseUtility;
using Tests.PageObjects.Payroll;

namespace Tests.Scenarios.Payroll
{
    [TestFixture]
   // [Parallelizable(ParallelScope.Self)]
    public class PAY_Create_Consolidation_Group : BaseTest
    {
        static string testName = "HireAnEmployee";
        [Test, TestCaseSource("getData")]
        public void PAY_Create_Consolidation_Group_Test(Dictionary<string, string> data)
        {   
