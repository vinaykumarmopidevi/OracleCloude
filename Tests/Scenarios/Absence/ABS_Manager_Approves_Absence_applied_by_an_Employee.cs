...
using TestFrameworkTutorial.TestBaseUtility;
using Tests.PageObjects.Absence;

namespace Tests.Scenarios.Absence
{
    [TestFixture]
   // [Parallelizable(ParallelScope.Self)]
    public class ABS_Manager_Approves_Absence_applied_by_an_Employee : BaseTest
    {
        static string testName = "HireAnEmployee";
        [Test, TestCaseSource("getData")]
        public void ABS_Manager_Approves_Absence_applied_by_an_Employee_Test(Dictionary<string, string> data)
        {   
