...
namespace Tests.Scenarios.Absence
{
   ...
   // [Parallelizable(ParallelScope.Self)]
    public class ABS_Manager_Enters_Absence_for_an_Employee : BaseTest
    {
        static string testName = "HireAnEmployee";
        [Test, TestCaseSource("getData")]
        public void ABS_Manager_Enters_Absence_for_an_Employee_Test(Dictionary<string, string> data)
        {   
