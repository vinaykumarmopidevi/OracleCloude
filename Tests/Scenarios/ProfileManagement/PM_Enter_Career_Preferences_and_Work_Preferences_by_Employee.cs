...
namespace Tests.Scenarios.ProfileManagement
{
   ...
   // [Parallelizable(ParallelScope.Self)]
    public class PAY_Create_Deduction_Element : BaseTest
    {
        static string testName = "HireAnEmployee";
        [Test, TestCaseSource("getData")]
        public void PAY_Create_Deduction_Element_Test(Dictionary<string, string> data)
        {   
           ...
           // openBrowser(data["Browser"]);
            //HR_Pages.HomePage.GoTo();
            //HR_Pages.HomePage.Login(Configuration.ConfigurationManager.AppSettings["Username"]);
            //HR_Pages.HomePage.Password(Configuration.ConfigurationManager.AppSettings["Password"]);
            //HR_Pages.HomePage.LoginButton();
