...
namespace Tests.Scenarios.ProfileManagement
{
   ...
   // [Parallelizable(ParallelScope.Self)]
    public class PM_Enter_Skills_and_Qualifications_by_Employee : BaseTest
    {
        static string testName = "HireAnEmployee";
        [Test, TestCaseSource("getData")]
        public void PM_Enter_Skills_and_Qualifications_by_Employee_Test(Dictionary<string, string> data)
        {   
