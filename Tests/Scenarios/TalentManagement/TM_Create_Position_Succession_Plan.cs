...
using TestFrameworkTutorial.TestBaseUtility;
using Tests.PageObjects.TalentManagement;

namespace Tests.Scenarios.TalentManagement
{
    [TestFixture]
   // [Parallelizable(ParallelScope.Self)]
    public class TM_Create_Position_Succession_Plan : BaseTest
    {
        static string testName = "HireAnEmployee";
        [Test, TestCaseSource("getData")]
        public void TM_Create_Position_Succession_Plan_Test(Dictionary<string, string> data)
        {   
           ...
           // Assert.IsTrue(HomePage.IsAtNavigatorPage("You have a new home page!"));
