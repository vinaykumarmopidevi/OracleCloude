...
using TestFrameworkTutorial.TestBaseUtility;
using Tests.PageObjects.LearningManagement;

namespace Tests.Scenarios.LearningManagement
{
    [TestFixture]
   // [Parallelizable(ParallelScope.Self)]
    public class LM_Create_Specialization : BaseTest
    {
        static string testName = "HireAnEmployee";
        [Test, TestCaseSource("getData")]
        public void LM_Create_Specialization_Test(Dictionary<string, string> data)
        {   
