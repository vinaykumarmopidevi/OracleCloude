...
namespace SeleniumTests.Benefits
{
   ...
   // [Parallelizable(ParallelScope.Self)]
    public class BEN_Defining_Derived_Eligibility_Factor_for_Age_and_Service : BaseTest
    {
        static string testName = "HireAnEmployee_Test1";
        [Test, TestCaseSource("getData")]
        public void BEN_Defining_Derived_Eligibility_Factor_for_Age_and_Service_Test(Dictionary<string, string> data)
        {   
