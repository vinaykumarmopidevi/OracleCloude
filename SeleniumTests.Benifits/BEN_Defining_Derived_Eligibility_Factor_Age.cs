...
namespace SeleniumTests.Benefits
{
   ...
   // [Parallelizable(ParallelScope.Self)]
    public class BEN_Defining_Derived_Eligibility_Factor_Age : BaseTest
    {
        static string testName = "HireAnEmployee_Test1";
        [Test, TestCaseSource("getData")]
        public void BEN_Defining_Derived_Eligibility_Factor_Age_Test(Dictionary<string, string> data)
        {   
