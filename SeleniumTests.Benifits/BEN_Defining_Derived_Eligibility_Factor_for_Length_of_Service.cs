...
namespace SeleniumTests.Benefits
{
   ...
   // [Parallelizable(ParallelScope.Self)]
    public class BEN_Defining_Derived_Eligibility_Factor_for_Length_of_Service : BaseTest
    {
        static string testName = "HireAnEmployee_Test1";
        [Test, TestCaseSource("getData")]
        public void BEN_Defining_Derived_Eligibility_Factor_for_Length_of_Service_Test(Dictionary<string, string> data)
        {   
